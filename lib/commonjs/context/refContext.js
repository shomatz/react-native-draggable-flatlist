...
var _jsxFileName =
  "/Users/azzuhry/project/react-native-draggable-flatlist/src/context/refContext.tsx";
...
function RefProvider(_ref) {
  ...
  return _react.default.createElement(
    RefContext.Provider,
    {
      value: value,
      __self: this,
      __source: { fileName: _jsxFileName, lineNumber: 34, columnNumber: 10 },
    },
    children
  );
}
...
function useSetupRefs(_ref2) {
  ...
  var propsRef = (0, _reactNativeReanimated.useSharedValue)(props);
  ...
  var cellDataRef = (0, _reactNativeReanimated.useSharedValue)(new Map());
  var keyToIndexRef = (0, _reactNativeReanimated.useSharedValue)(new Map());
